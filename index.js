...
$(window).scroll(function() {
  var scroll = $(window).scrollTop();
  if (scroll > 6900) {
    $(".right").addClass("animate__zoomIn");
  } else {
    $(".right").removeClass("animate__zoomIn");
  }
  });
...
$(window).scroll(function() {
  var scroll = $(window).scrollTop();
  if (scroll > 6900) {
    $(".left").addClass("animate__zoomIn");
  } else {
    $(".left").removeClass("animate__zoomIn");
  }
});
...
$(window).scroll(function() {
  var scroll = $(window).scrollTop();
  if (scroll > 6900) {
    $(".right-anim").addClass("animate__fadeInLeft");
  } else {
    $(".right-anim").removeClass("animate__fadeInLeft");
  }
});
...
$(window).scroll(function() {
  var scroll = $(window).scrollTop();
  if (scroll > 6900) {
    $(".left-anim").addClass("animate__fadeInRight");
  } else {
    $(".left-anim").removeClass("animate__fadeInRight");
  }
});
